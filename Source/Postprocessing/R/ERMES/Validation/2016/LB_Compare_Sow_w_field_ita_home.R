...
it_raster_file_16 = 'Z:/IT/2016/v1.0/Outputs/2016/Phenorice_IT_2016.dat'
it_2km_tif_16 = 'Z:/IT/2016/v1.0/Outputs/ERMES_Grid/TIFFS/2016/MinDoys/IT_Phenology_MinDoys_2016_203.tif'


it_shape_file_15 = 'Z:/Validation/2016/IT/Accessory/Static_info_2015_sinu.shp'
it_raster_file_15 = 'Z:/IT/2016/v1.0/Outputs/2015/Phenorice_IT_2015.dat'
it_2km_tif_15 = 'Z:/IT/2016/v1.0/Outputs/ERMES_Grid/TIFFS/2015/MinDoys/IT_Phenology_MinDoys_2015.tif'

it_shape_file_14 = 'Z:/Validation/2016/IT/Accessory/Static_info_2014_sinu.shp'
it_raster_file_14 = 'Z:/IT/2016/v1.0/Outputs/2014/Phenorice_IT_2014.dat'
it_2km_tif_14 = 'Z:/IT/2016/v1.0/Outputs/ERMES_Grid/TIFFS/2014/MinDoys/IT_Phenology_MinDoys_2014.tif'

it_grid = 'Z:/Validation/2016/IT/Accessory/IT_ERMES_Regional_Grid.shp'
...
save(it_ras_fields_15, file = 'Z:/Validation/2016/IT/IT_15.RData')
...
it_ras_fields_14 = raster::extract(it_rast_14,it_shape_14,weights=TRUE,fun = mean,na.rm = T, df = T)
save(it_ras_fields_14, file = 'Z:/Validation/2016/IT/IT_14.RData')
# ras_fields_stdev_14 = extract(it_rast,it_shape_14,fun = sd, na.rm = T, df = T)
load('Z:/Validation/2016/IT/IT_14.RData')
...
sub_tot = droplevels(subset(sub_tot))
...
save(it_or_melt,it_or, file = 'Z:/Validation/2016/IT/IT_val_or.RData')
