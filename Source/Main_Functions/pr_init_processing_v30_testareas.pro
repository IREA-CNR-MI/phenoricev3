...
; :License: GPL>3.0
;-
FUNCTION pr_init_processing_v30_testareas, in_files, opts, out_rast_list, ind_year
  ...
  ; Start cyclying on ROIS
  
  
  
  
  ; Cycle on pixels of each ROI
  
  
  
  
  ; Process ith pixel of the ROI
